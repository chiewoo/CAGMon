...
dat = np.loadtxt('MaxRedMatrixPCC0.txt')
...
fig.suptitle('Correlation Map via Pearson Correlation between 250 Auxiliary Channels', fontsize=25, fontweight='bold')
ax.invert_yaxis()
ax.xaxis.tick_top()
plt.xticks(rotation=90)
ax.set_xticklabels(row_labels, minor=False, fontsize=3)
ax.set_yticklabels(column_labels, minor=False, fontsize=3)
fig.savefig('CMapPCC.png',dpi=500)
plt.show()
