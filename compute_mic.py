...
num_attrib = opts.number_attribute
...
#            mi2=normalized_mutual_info_score(f.T[i], f.T[j])
            mi2=mutual_info_score(f.T[i], f.T[j])
...
dat_file=output_dir+'/'+filename+'_reduced_null_rmvd_dat.txt'
...
chlist=[]
chan=[]
for i in range(0,num_chan*num_attrib):
